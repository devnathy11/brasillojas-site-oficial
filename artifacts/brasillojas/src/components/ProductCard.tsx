...
export function ProductCard({ product, index = 0 }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className="product-card bg-white rounded-lg border border-gray-200 overflow-hidden group flex flex-col"
    >
      {/* Image - clickable */}
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        <Link href={`/products/${product.id}`} className="block">
          <h3 className="text-sm font-medium text-gray-800 line-clamp-2 leading-tight mb-2 hover:text-[#1B5E20] cursor-pointer min-h-[2.5rem]">
            {product.name}
          </h3>
        </Link>
        ...
        <button
          ...
          className="mt-auto w-full py-2 px-3 bg-[#1B5E20] hover:bg-[#2E7D32] disabled:bg-gray-300 text-white text-sm font-semibold rounded flex items-center justify-center gap-2 transition-colors relative overflow-hidden"
        >
